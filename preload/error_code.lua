SYSTEM_ERROR = {
	service_off = 1,	--服务器维护中
}

AUTH_ERROR = {
	login_success = 0,
	param_error = 1,			--参数有误
	service_fix = 2,			--服务器维护中
	account_off = 3,			--封号
	new_version = 4,			--有新版本
	db_error  = 5,				--数据库异常
	service_off = 500,			--服务器正在维护
}

-- local index = 0
-- local function add(tb, key) 
-- 	tb[err] = 
-- end

-- add(SYSTEM_ERROR, "login_success", "登录成功", 0)
-- add(SYSTEM_ERROR, "account_nil", "账号为空")
